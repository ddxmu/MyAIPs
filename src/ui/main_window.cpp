...
bool confirm_psd_raster_preview_font_substitution(QWidget* parent, const QStringList& missing_fonts) {
  ...
  if (missing_fonts.size() == 1) {
    dialog.setText(QObject::tr("MyAIPs can't locate the font \"%1\". Editing this PSD raster preview will substitute "
                               "another font. Continue?")
                       .arg(missing_fonts.front()));
  } else {
    dialog.setText(QObject::tr("MyAIPs can't locate these fonts: %1. Editing this PSD raster preview will substitute "
...
MainWindow::MainWindow(QWidget* parent) : QMainWindow(parent) {
  ...
  connect(start_panel_, &StartPanel::ai_assistant_requested, this, [this] { open_ai_chat_dialog(); });
